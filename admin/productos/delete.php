<?php
global $productos, $codigo, $nombre_producto, $descripcion, $stock, $stock_minimo, $stock_maximo, $precio_compra, $fecha_de_ingreso, $precio_venta, $URL, $id_usuario;
        ...
        <div class="col-md-12">
            <div class="card card-outline card-danger">
                <div class="card-header">
                    <h3 class="card-title"><b>¿Estas seguro de elimar este producto?</b></h3>
                </div>
                <div class="card-body">
